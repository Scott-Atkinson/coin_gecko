...
MockCoinService getAndRegisterCoinService() {
  _removeRegistrationIfExists<CoinService>();
  final service = MockCoinService();
  locator.registerSingleton<CoinService>(service);
  return service;
}
